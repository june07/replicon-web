...
const apiService = () => {
    ...
    return {
        ...
        replicate: async (serverId, data) => await request({ data, method: 'POST', responseType: 'blob', url: `${VITE_APP_API_SERVER}/v1/replicon/replicate/${serverId}` }),
    }
}
